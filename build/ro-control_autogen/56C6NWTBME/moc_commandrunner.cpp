...
#include "../../../src/backend/system/commandrunner.h"
...
void CommandRunner::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->outputLine((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (CommandRunner::*)(const QString & )>(_a, &CommandRunner::outputLine, 0))
            return;
    }
}
...
// SIGNAL 0
void CommandRunner::outputLine(const QString & _t1)
{
